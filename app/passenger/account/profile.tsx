...
import { IconCamera, IconCloseEye, IconEdit, IconEmail, IconGoogleIcon, IconLock, IconOpenEye, IconProfile, IconSmallRightTick } from '@/assets/icon/Icon'
...
const profile = () => {
    ...
    return (
        ...
        <View style={tw`flex-1 bg-base gap-2`}>
            <BackWithComponent togather onPress={() => {
                router?.back();
            }} title={"Account & security"} ComponentBtn={<View>
                <Text style={tw`text-[#5C7B7E] text-base font-normal`}>Edit <SvgXml xml={IconEdit} /> </Text>
            </View>} />
            <View style={tw`items-center my-12 `}>
                <View style={tw`relative`}>
                    <Image
                        ...
                        <SvgXml xml={IconCamera} style={tw`absolute bottom-7 right-1 bg-base p-4 rounded-full`} />
                </View>
                <Text style={tw`text-2xl font-bold mb-1 text-black font-NunitoSansRegular`}>Lana Yolo</Text>
                <Text style={tw`text-sm font-semibold font-NunitoSansRegular`}>ID: 05745</Text>
            </View>

            <View style={tw`w-[370px]  mx-auto rounded-2xl shadow-md bg-white `}>
            <Text style={tw`text-2xl mt-5 ml-4 font-bold text-[#172B4D] font-NunitoSansRegular`}>General Information</Text>
                <Formik
            ...
            <SideModal visible={modalVisible} setVisible={setModalVisible} >
                <View style={tw` bg-black bg-opacity-50 justify-center items-center`}>
                    <View style={tw`w-full bg-white p-5  shadow-lg`}>
                        <Text style={tw`text-2xl font-bold text-[#172B4D] font-NunitoSansRegular`}>Update Password</Text>
                        <Formik

  ...
  return (
    <ScrollView>
      <View>
        ...
        <View>
          <Text style={tw`font-bold text-3xl my-6 px-4 text-[#172B4D] font-NunitoSansRegular`}>About Ride Along Jr application</Text>
        </View>
        <View>
            <Text style={tw`my-3 px-4 text-lg font-normal`}>Overview</Text>
            <Text style={tw`my-3 px-4 text-lg font-normal mt-3`}>Ride Along Jr is a user-friendly ride-sharing application designed specifically for families and young passengers. The app provides a safe, efficient, and convenient way for parents to schedule rides for their children, ensuring a reliable transportation experience with verified drivers.</Text>
        </View>
        <View>
...

            {
              items.map((item, index) => (
                <Text style={tw`my-2 px-4 text-lg font-normal`}>{index + 1}. {item}</Text>
              ))
            }
        </View>
      </View>

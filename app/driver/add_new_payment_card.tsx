...
const add_new_pyment_card = () => {
  ...
  return (
    <View>
      <BackWithComponent
        togather
        title={t("driver.payment.addPaymentMethod")}
        onPress={() => router.back()}
      />
        ...
        <View style={tw`my-1`}>
          <View style={tw`border border-gray-300 rounded-lg p-3`}>
            <View style={tw`flex-row justify-between items-center`}>
              <TextInput
                placeholder={t("driver.payment.cardNumber")}
          ...
          <View style={tw`flex-row mt-3`}>
            ...
            <View style={tw`flex-1 border border-gray-300 rounded-lg p-3`}>
              <TextInput
                placeholder={t("driver.payment.cvv")}
                keyboardType="numeric"
                secureTextEntry
                style={tw`text-lg`}
              />
          ...
          <TButton
            title={t("driver.payment.saveCard")}
            onPress={() => {
              router.back();
            }}
          />

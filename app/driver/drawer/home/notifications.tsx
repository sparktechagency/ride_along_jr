      ...
      {isNotification ? (
                ...
                <View style={tw`flex-1 flex-row items-center gap-4`}>
                  ...
                  <View style={tw`flex-1 `}>
                    <Text style={tw`text-base font-bold text-[#172B4D]`}>
                      {t("driver.notifications.paymentSuccessful")}
                    </Text>
                    <Text
                      numberOfLines={1}
                      style={tw` text-sm font-normal text-[#3E4F6B]`}
                    >
                      {t("driver.notifications.paymentDescription")}
                    </Text>
                  </View>
                </View>
                <View style={tw``}>
                  ...
                  >
                    {t("driver.notifications.timeStamp")}
                  </Text>
                </View>
              </View>
            </View>
        ...
        <>
          <View style={tw`py-12 px-24 justify-center gap-4`}>
            ...
            >
              {t("driver.notifications.nothingToShow")}
            </Text>
            <Text style={tw`text-base text-center font-semibold mb-3`}>
              {t("driver.notifications.notifyUpdates")}
            </Text>
          </View>
        </>
      )}

...
const driver_arriving = () => {
  ...
  // React.useEffect(() => {
  //   setTimeout(() => {
  //     router?.push("/passenger/driver_arrived");
  //   }, 3000);
    ...
    `}
      ...
      >
        <View style={tw`px-4 `}>
          ...
          <TButton
            title={t("driver.trip.arrived")}
            containerStyle={tw`mt-4  gap-1 h-14`}
            titleStyle={tw``}
            onPress={() => {
              router?.push("/driver/driver_arrived");
            }}
          />
          <IwtButton
            svg={IconCloseRed}
...
export default driver_arriving;
